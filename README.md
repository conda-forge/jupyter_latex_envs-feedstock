About jupyter_latex_envs-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter_latex_envs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=494&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter_latex_envs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter_latex_envs` can be installed with `conda`:
...
```
mamba install jupyter_latex_envs
```

It is possible to list all of the versions of `jupyter_latex_envs` available on your platform with `conda`:
...
```
mamba search jupyter_latex_envs --channel conda-forge
```
...
mamba repoquery search jupyter_latex_envs --channel conda-forge

# List packages depending on `jupyter_latex_envs`:
mamba repoquery whoneeds jupyter_latex_envs --channel conda-forge

# List dependencies of `jupyter_latex_envs`:
mamba repoquery depends jupyter_latex_envs --channel conda-forge
```
